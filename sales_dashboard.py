# ------------------------
# SALES DASHBOARD WITH LOGIN SUPPORT AND FULL VISUALS
# ------------------------
...
# [The full merged code from your 1407-line script continues here...]
...
USERS = {
    ...
    "john": {"password": "doe123", "name": "John Doe"},
    "kritikal": {"password": "solutions", "name": "KritiKal Team"}
}
...
def login_page():
    st.markdown("""
        <div style='text-align: center; margin-top: 50px;'>
            <h1 style='font-size: 3em; color: #4A90E2;'>🔐 Welcome to Sales Dashboard</h1>
            <p style='font-size: 1.2em; color: #777;'>Please log in to access your data</p>
        </div>
    """, unsafe_allow_html=True)
